    ...
    <template v-if="children && Array.isArray(children) && children.length === 2">
      <el-col :span="11">
        <el-date-picker
          ...
          :disabled="disabled"
          :value-format="dateFormat(type)"
          v-model="children[0].value"
          @change="valueChange(children[0].name, $event)"
        />
      </el-col>
      ...
      <el-col :span="11">
        <el-date-picker
          ...
          :disabled="disabled"
          :value-format="dateFormat(type)"
          v-model="children[1].value"
          @change="valueChange(children[1].name, $event)"
        />
      </el-col>
    </template>
    <template v-else>
